...
int* processImage(int* inputImage, int processId, int num_processes, int image_height, int image_width, int height_start, int height_end){
	...
	int chunkSize;
    int* partialOutputImage = new int[image_width * image_height];
	
	for( x = height_start; x < height_end; x++ ){
...
{
	int processId, num_processes = 1, image_height, image_width, image_maxShades;
...
//	***************** Add code as per your requirement below ********************* 
    ...
    outputImage = processImage(inputImage, 0, 0, image_height, image_width, 0, image_height);
